...
<footer class="footer items-center p-1 bg-neutral text-neutral-content absolute bottom-0">
    ...
    <div class="items-center grid-flow-col">
        ...
        <p class="min-[500px]:hidden">Copyright © 2023 - All right reserved</p>
        <button on:click={() => goto("https://discord.gg/Vu5bUHSEyE")}
                class="btn btn-xs cursor-pointer relative float-left left-1.5">
            <Icon icon="fontisto:discord"/>
        </button>
    </div>

    <div class="grid-flow-col gap-3 justify-self-end">
            <a class="relative top-2">
        ...
        <div class="dropdown dropdown-top">
            <label tabindex="0" class="btn btn-sm btn-accent m-1 capitalize text-xs">
